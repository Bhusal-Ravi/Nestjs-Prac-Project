...
const regionConfigs = [
  ...
  },
  {
    ...
    port: Number(process.env.USA_MYSQL_PORT ?? 3306),
    username: process.env.USA_MYSQL_USER ?? 'root',
    password: process.env.USA_MYSQL_PASSWORD ?? 'test',
...
export const databaseProviders: Provider[] = [
  {
    provide: 'DATA_SOURCE_MAP',  
    useFactory: async (): Promise<Map<string, DataSource>> => {
...
//     {
//     provide: 'DATA_SOURCE',
//     useFactory: async () => dataSource[0].initialize(),
//   },
//   {
